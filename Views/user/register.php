...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                        ...
                        <form id="registerForm">
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    <input type="text" class="form-control input-lg" name="name" placeholder="Imię" required>
                                </div>
                                <div class="form-group col-md-12 mb-4">
                                    <input type="text" class="form-control input-lg" name="login" placeholder="Login" required>
                                </div>
                                <div class="form-group col-md-12 mb-4">
                                    <input type="text" class="form-control input-lg" name="discord" placeholder="Nick Discord (Abcd#1234)" required>
                                </div>
                                <div class="form-group col-md-12 ">
                                    <input type="password" class="form-control input-lg" name="password" placeholder="Hasło" required>
                                </div>
                                <div class="form-group col-md-12 ">
                                    <input type="password" class="form-control input-lg" name="cpassword" placeholder="Powtórz hasło" required>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">Zarejestruj</button>
                                    <p>Posiadasz już konto?
                                        <a class="text-blue" href="<?=$this->base_path?>user/login">Zaloguj się</a>
                                    </p>
                                </div>
                            </div>
                        </form>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2019 Copyright RP-Route68, Made by Om4n3k.
            </p>
        </div>
    </div>
