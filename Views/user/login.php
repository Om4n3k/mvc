            ...
            <div class="col-xl-5 col-lg-6 col-md-10">
                <div class="card">
                    ...
                    <div class="card-body p-5">
                        ...
                        <h4 class="text-dark mb-5">Zaloguj się</h4>
                        <form id="loginForm">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 ">
                                    <input type="password" class="form-control input-lg" name="password" placeholder="Hasło">
                                </div>
                                <div class="col-md-12">
                                    <div class="d-flex my-2 justify-content-between">
                                        <div class="d-inline-block mr-3">
                                            <label class="control control-checkbox">Zapamiętaj mnie
                                                <input type="checkbox" />
                                                <div class="control-indicator"></div>
                                            </label>

                                        </div>
                                        <p><a class="text-blue" href="#">Zapomniałeś hasła?</a></p>
                                    </div>
                                    <div id="formResult"></div>
                                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">Zaloguj</button>
                                    <p>Nie posiadasz jeszcze konta?
                                        <a class="text-blue" href="<?= $this->base_path ?>user/register">Zarejestruj się</a>
                                    </p>
                                </div>
                            </div>
                        </form>
